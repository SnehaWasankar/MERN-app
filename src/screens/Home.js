...
export default function Home() {
    ...
    const loadData = async () => {
        ...
        //console.log(response[0], response[1]); // to access food category and items
    }
            ...
            <div className='container'>
                            ...
                            return (
                                <div className='row mb-3' key={data._id}>
                                    ...
                                    {foodItem !== []
                                        ...
                                        : <div key={data._id}>No such data found</div>} {/* Provide a unique key */}
                                </div>
                            );
                        })
                ...
                {/* {
                    foodCat !== []
                        ...
                        : ""
                    //if condition is true perform ? else perform :
                } */}
